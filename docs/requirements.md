...
As a user I want to delete a task so that my daily plan doesn't get cluttered with tasks I no longer need.

Acceptance Criteria:

- A user can delete a task from their daily plan.
- Once deleted, the task no longer appears in the daily plan.
- Deleting a task does not affect any other task in the plan.
